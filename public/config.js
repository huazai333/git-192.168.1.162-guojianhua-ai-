window.GLOBAL_CONFIG = {
    DEV_BASE_URL: "http://192.168.62.182:8080", // 开发环境	PROD_SIT_BASE_URL: window.location.protocol + '//' + window.location.hostname + ":9080", // 集成测试环境
    ...
    PROD_BASE_URL: "http://192.168.1.148:9080", // 生产环境
    ...
    socketURL: 'ws://192.168.1.166:9080/system/ws', // 报警数据（PM2.5）
    VISITOR_SOCKET_URL: "ws://127.0.0.1:3001", //访客登记webscoket地址(Node服务，目前部署在教学楼一楼访客接待大厅前台)

    IMG_SERVER_URL: 'http://192.168.1.148:9000/access/', // 图片前缀（全局使用）
