    ...
    <div class="item1">
      ...
      >
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="设备条件" name="first">
            <div class="item2">
              <el-form-item
                label="设备数量权重系数："
                prop="deviceNumberCoefficient"
                style="width: 20%"
              >
                <el-input
                  v-model.number="modelForm.deviceNumberCoefficient"
                  placeholder="请输入"
                  clearable
                ></el-input>
              </el-form-item>
              <el-form-item
                label="设备出现次数权重系数："
                prop="deviceFrequencyCoefficient"
                style="width: 20%"
              >
                <el-input
                  v-model.number="modelForm.deviceFrequencyCoefficient"
                  placeholder="请输入"
                  clearable
                ></el-input>
              </el-form-item>
          ...
          <el-tab-pane label="APP条件" name="third">
            <div class="item2">
              <el-form-item
                label="安装重点app设备数量系数："
                prop="appNumberCoefficient"
                style="width: 20%"
              >
                <el-input
                  v-model.number="modelForm.appNumberCoefficient"
                  placeholder="请输入"
                  clearable
                ></el-input>
              </el-form-item>
              <el-form-item
                label="安装重点app设备出现次数权重系数："
                prop="appFrequencyCoefficient"
                style="width: 20%"
              >
                <el-input
                  v-model.number="modelForm.appFrequencyCoefficient"
                  placeholder="请输入"
                  clearable
                ></el-input>
              </el-form-item>
...
export default {
  data() {
    return {
      ...
      modelForm: {
        ...
        modelName: "异常窝点",
        type: "1",
        deviceNumberCoefficient: 10,
        deviceFrequencyCoefficient: 10,
        appNumberCoefficient: 10,
        appFrequencyCoefficient: 10,
  ...
  methods: {
    ...
    start() {
      // 判断有无配置数据
      if (this.dataSource.length != 0 || this.appdataSource.length != 0) {
        let data = {
          modelId: this.id,
          modelType: this.modelForm.modelType,
          modelStatus: 0,
