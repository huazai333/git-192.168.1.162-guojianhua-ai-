	...
	<el-card shadow="never" class="aui-card--fill">
		<el-form ref="ruleForm" :model="dataForm" label-width="80px" inline>
			...
			<el-form-item>
				...
				<el-button type="primary" @click="uploadExcel">导入信息</el-button>
				<el-button type="primary" @click="uploadImg"  v-if="$hasPermission('system:scworkersarchives:importImg')">导入图片</el-button>
				<el-button type="primary" @click="exportHandle" v-loading="loading">导出信息</el-button>
			</el-form-item>
		</el-form>
		<el-table :data="dataList" @selection-change="checkListHandle">
			...
			<el-table-column prop="scWaname" label="姓名" show-overflow-tooltip align="center"></el-table-column>
			<el-table-column prop="scStatus" label="状态" show-overflow-tooltip align="center">
				<template slot-scope="scope">
					<el-tag v-if="scope.row.scStatus === 0" size="small" type="success">在职</el-tag>
					<el-tag v-else size="small" type="warning">离职</el-tag>
				</template>
			</el-table-column>
			<el-table-column prop="scEmpno" label="职工编号" show-overflow-tooltip align="center"></el-table-column>
			<el-table-column prop="deptName" label="部门" show-overflow-tooltip align="center"></el-table-column>
			<el-table-column prop="scWasex" label="性别" :formatter="formatterSex" show-overflow-tooltip align="center"></el-table-column>
			<el-table-column prop="scHiredate" label="入职时间" show-overflow-tooltip align="center"></el-table-column>
			<el-table-column prop="scEmptype" label="职位" :formatter="formatterType" show-overflow-tooltip align="center"></el-table-column>
