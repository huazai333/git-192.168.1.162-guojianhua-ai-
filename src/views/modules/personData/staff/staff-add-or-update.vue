    ...
    <div>
      <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="100px">
        ...
        <el-row>
          ...
          <el-col :span="11" :offset="1">
            <el-form-item label="职位" prop="scEmptype">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="IC卡" prop="scUwbid">
              <el-input v-model.trim="dataForm.scUwbid" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11" :offset="1">
            <el-form-item label="RF卡" prop="scRfcardid">
  ...
  export default {
    ...
    methods:{
      ...
      getDeviceByDept(deptId){
        if (deptId) {
          this.$http({
            url: "/system/scworkersarchives/devices/" + deptId,
            method: 'get',
            data: this.dataForm
          }).then(({ data }) => {
            if (data.code === 0) {
              this.dataForm.devices = data.data
            }
      ...
      init(data){
        ...
        if(data){
          ...
          this.$nextTick(() => {
            ...
            this.getDeviceByDept(data.deptId)
          })
        }
        else{
          this.type="post";
