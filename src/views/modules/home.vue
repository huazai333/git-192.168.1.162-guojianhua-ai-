<template>
    <div class="home" ref="home">
        ...
        <admin></admin>
        <home-dormitory v-if="$hasPermission('sys:home:dormitory')"></home-dormitory>
        <home-building v-if="$hasPermission('sys:home:building')"></home-building>
    </div>
</template>
...
<script>
  ...
  import test from'./test/HelloWorld.vue'
  ...
  export default {
    components: {
      test,admin,homeDormitory ,homeBuilding
    },
    computed:{
