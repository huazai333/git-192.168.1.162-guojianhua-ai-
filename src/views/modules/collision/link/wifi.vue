  ...
  <el-card shadow="never" class="aui-card--fill">
    ...
    >
      ...
      >
        ...
        <el-form-item label="热点1 Mac:" prop="wifiMac1">
          <el-input
            v-model="addForm.wifiMac1"
            placeholder="请输入"
            clearable
          ></el-input>
        </el-form-item>
        <el-form-item label="热点2 Mac:" prop="wifiMac2">
          <el-input
            v-model="addForm.wifiMac2"
            placeholder="请输入"
            clearable
          ></el-input>
        </el-form-item>
    ...
    addok() {
      this.$refs.ruleFormAdd.validate((valid) => {
        ...
        var params = {
          ...
          wifiMac1: this.addForm.wifiMac1,
          wifiMac2: this.addForm.wifiMac2,
        };
