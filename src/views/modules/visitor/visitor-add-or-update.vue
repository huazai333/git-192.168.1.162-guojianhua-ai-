	...
	<el-dialog :title="type=='post'?'新建':'编辑'" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<div>
			<el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="100px">
				<el-row>
					<el-col :span="6">
						<el-form-item label="照片" prop="photo"  class="block-item">
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="姓名" prop="vrName">
							<el-input v-model="dataForm.vrName" placeholder="请输入" clearable disabled></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="11" :offset="1">
						<el-form-item label="身份证号" prop="vrIdno">
							<el-input v-model="dataForm.vrIdno" placeholder="请输入" clearable disabled></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					...
					<el-col :span="11" :offset="1">
						<el-form-item label="性别" prop="vrSex">
							<el-radio-group v-model="dataForm.vrSex" placeholder="请输入" disabled>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="被访人员" prop="vrInterviewed">
							<el-select v-model="dataForm.vrInterviewed" clearable placeholder="请选择" filterable @change="getPhoneHandle" disabled>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="被访人电话" prop="vrInterviewedPhone">
							<el-input v-model="dataForm.vrInterviewedPhone" placeholder="请输入" clearable disabled></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="11" :offset="1">
						<el-form-item label="访客电话" prop="vrPhone">
							<el-input v-model="dataForm.vrPhone" placeholder="请输入" clearable disabled></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
						<el-form-item label="访问地址" prop="vrAddress">
							<el-input v-model="dataForm.vrAddress" placeholder="请输入" clearable disabled></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="11" :offset="1">
						<el-form-item label="访问楼层" prop="dfFloorid">
							<el-cascader v-model="dataForm.dfFloorid" :props="{ value: 'df_floorid', label: 'df_floorname',emitPath:false}"
							 clearable placeholder="请选择" :options="FloorList" style="width: 100%;" disabled></el-cascader>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col>
						<el-form-item label="访问事由" prop="vrReasons">
							<el-input type="textarea" :rows="3" resize="none" v-model="dataForm.vrReasons" placeholder="请输入" clearable disabled></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
		...
		methods: {
			...
			submitInfo: debounce(function() {
				this.$refs['dataForm'].validate((valid) => {
					...
					this.$http({
						url: "/system/scvisitorrecord/bind/" + this.dataForm.vrId ,
						method: this.type,
						data: {'vrUwbid':this.dataForm.vrUwbid,'vrTemperature':this.dataForm.vrTemperature}
					}).then(({
						data
					}) => {
						if (data.code != 0) {
