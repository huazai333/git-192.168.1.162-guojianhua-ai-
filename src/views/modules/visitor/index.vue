...
<!--			<el-form-item label="人证设备">
		...
		<el-table :data="dataList">
			...
			<el-table-column prop="valid" label="是否可访问" show-overflow-tooltip align="center">
				<template slot-scope="scope">
					<div>
						<span style="color:#67C23A;"  v-if="scope.row.valid === 1">是</span>
			...
			<el-table-column label="操作" width="180" align="center">
				<template slot-scope="scope">
					<div>
						...
						<el-button type="text" v-if="scope.row.valid === 1 && !scope.row.vrUwbid" @click="editVisitor(scope.row)">绑卡</el-button>
					</div>
				</template>
			</el-table-column>
		</el-table>
