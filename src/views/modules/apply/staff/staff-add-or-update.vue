  ...
  >
    <div>
      <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="100px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="IC卡" prop="uwb">
              <el-input v-model.trim="dataForm.uwb" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11" :offset="1">
            <el-form-item label="RF卡" prop="rf">
              <el-input v-model="dataForm.rf" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
