	...
	<el-dialog title="详情" :visible.sync="dialogVisible" width="700px" :close-on-click-modal="false">
		<div>
			<el-row>
				...
				<el-col :span="9">{{dataForm.sex | filterLabel('gender')}}</el-col>
			</el-row>

			<el-row>
				<el-col :span="3">被访人：</el-col>
				<el-col :span="9">{{dataForm.interviewedName}}</el-col>
				<el-col :span="3">被访电话：</el-col>
				<el-col :span="9">{{dataForm.interviewedMobile}}</el-col>
			</el-row>
			...
			<el-row>
				<el-col :span="3">访问时间：</el-col>
				<el-col :span="9">{{dataForm.startTime | formatterInTime(dataForm.startTime)}} -- {{dataForm.endTime | formatterInTime(dataForm.endTime)}}</el-col>
				<el-col :span="3"> 登记时间：</el-col>
				<el-col :span="9">{{dataForm.createTime}}</el-col>
			</el-row>
			<el-row>
				<el-col :span="3">访问楼层：</el-col>
				<el-col :span="9">{{floorName}}</el-col>
				<el-col :span="3">访问地址：</el-col>
				<el-col :span="9">{{dataForm.address}}</el-col>
			</el-row>
			<el-row>
	...
	export default {
		...
		methods: {
			init(data) {
				...
				this.$http({url:'/system/scdormitoryfloor/name/' + data.floorId,method:'get'}).then(({ data: res }) => {
					if (res.code !== 0) {
						return
					}
