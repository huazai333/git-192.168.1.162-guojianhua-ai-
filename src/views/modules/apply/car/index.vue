...
<!--			<el-form-item label="职工编号" prop="code">
		...
		<el-table :data="dataList" @selection-change="checkListHandle" >
			...
			<el-table-column prop="carNum" label="车牌号" show-overflow-tooltip align="center"></el-table-column>
			...
			<el-table-column prop="interviewee" label="通行时间" show-overflow-tooltip align="center">
				<template slot-scope="scope">
					{{scope.row.startDate | formatterDate(scope.row.startDate)}} - {{scope.row.endDate | formatterDate(scope.row.endDate)}}
				</template>
			</el-table-column>
		...
		data() {
			...
			return {
				mixinViewModuleOptions: {
					getDataListURL: '/system/travel/apply',
