  ...
  methods: {
    ...
    getInfo(item) {
      ...
      this.$http({
        ...
        this.wifi_result = res.data.wifi_result;
        this.analysis_device_info = res.data.wifi_result.analysis_device_info;
        this.accompany_device = res.data.wifi_result.accompany_device;
      });
    },
    getRule(item) {
