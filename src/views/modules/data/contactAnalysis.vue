  ...
  <el-card shadow="never" class="aui-card--fill">
    ...
    >
      ...
      >
        ...
        <el-form-item label="时间范围(秒)" prop="timeRange">
          <el-input
        ...
        <el-form-item label="空间范围(米)" prop="range">
          <el-input
      ...
      this.$refs.ruleFormAdd.validate((valid) => {
        ...
        if (
          ...
          var params = {
            ...
            timeRange: this.addForm.timeRange,
          ...
          this.$http
            .post("/hadoop/task/closeAccompanyAnalysis", data)
            .then(({ data: res }) => {
              if (res.code == 0) {
                this.$message({
                  type: "success",
