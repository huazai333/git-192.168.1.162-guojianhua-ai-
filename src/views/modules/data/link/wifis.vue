<template>
  ...
  width="50%">
  <el-row>
  <el-col :span="12"> <el-divider content-position="center">热点1</el-divider>
   <el-form ref="ruleFormAdd" :model="addForm" :rules="formAddRules" label-width="120px" >
     ...
     <el-col :span="12"> <el-divider content-position="center">热点2</el-divider>
