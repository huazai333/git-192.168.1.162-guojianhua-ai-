<template >
  <div class="detail_page">
    ...
    <el-dialog title="密接详情" :visible.sync="detail" width="60%">
      <el-table
        :data="
  ...
  methods: {
    ...
    getInfo(item) {
      ...
      this.$http({
        ...
        this.analysis_device_info = res.data.analysis_device_info;
        this.accompany_device = res.data.accompany_device;
        this.trajectory_num = res.data.trajectory_num
      });
    },
    getRule(item) {
