	...
	<div class="aui-wrapper aui-page__login">
		...
		<main class="aui-content">
			...
			<h2 class="login-brand">
				<!-- <img src="../../assets/img/login-title.png" alt="title"> -->
				AI算法应用平台
			</h2>
			</div>
  ...
  methods: {
    ...
    loginSelf() {
      return new Promise((resolve, reject) => {
        this.$http
          .post("/auth/oauth/token", this.dataForm, {
            headers: {
    ...
    dataFormSubmitHandle() {
      this.$refs["dataForm"].validate((valid) => {
        ...
        Promise.all(
          true ? [this.loginSelf()] : [this.loginSelf(), this.login3dSystem()]
        )
          .then((result) => {
            this.$router.replace({
            ...
            &.user-record {
              ...
              .el-checkbox {
                ...
                .el-checkbox__inner {
                  ...
                  background: rgba($color: rgb(92, 89, 89), $alpha: 0.2);
              ...
              .el-input__inner {
                ...
                &:-webkit-autofill {
                  -webkit-box-shadow: 0 0 0 1000px
                    rgba($color: #fff, $alpha: 0.3) inset;
                }
